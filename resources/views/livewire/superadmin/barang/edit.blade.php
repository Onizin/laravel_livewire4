<div wire:ignore.self class="modal fade" id="editModalBarang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" wire:click="update({{$barang_id}})"><i class="fas fa-save mr-1"></i>Save</button>
      </div>
    </div>
  </div>
</div>
