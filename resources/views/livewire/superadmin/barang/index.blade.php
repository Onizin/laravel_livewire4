        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"><i class="fas fa-user mr-1"></i>Dashboard</a>
              </li>
        ...
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item text-success" href="{{ route('superadmin.barang.export.excel') }}"><i class="fas fa-file-excel mr-1"></i>Excel</a>
              <a class="dropdown-item text-danger" href="{{ route('superadmin.barang.export.pdf') }}"><i class="fas fa-file-pdf mr-1"></i>PDF</a>
            </div>
          </div>
        </div>
        </div>
